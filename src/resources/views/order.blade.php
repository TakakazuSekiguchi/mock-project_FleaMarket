...
@section('content')
<form class="order__form" action="{{ route('purchase.store', ['item' => $item->id]) }}" method="POST">
    @csrf
    ...
    <div class="order__confilm">
        <div class="order__confilm-price">
            <span class="order__confilm-text">商品代金</span>
            <span class="order__confilm-text">&yen; {{ $item->price }}</span>
        </div>
        <div class="order__confilm-payment_method">
            <span class="order__confilm-text">支払い方法</span>
            <span class="order__confilm-text" id="payment_display">未選択</span>
        </div>
        @php
